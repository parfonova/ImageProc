...
*			isavi_AddFrame receives as parameter a pointer to the data to compress, and uses this inforcv::Mation 
*			to save only the valid data.
*
*
*  \param   nAviID:		Instance ID returned by isavi_InitAVI()
*  \param	cMode:		Color mode of the input data. There are four supported forcv::Mats (IS_AVI_CM_RGB32,
...
*           and uses this inforcv::Mation to save only the valid data.
*
*
*  \param   unFileID:     Instance ID returned by israw_InitFile()
*  \param	Width:		  Image width
