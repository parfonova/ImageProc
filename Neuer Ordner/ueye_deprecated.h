...
*   \author  (c) 2011 - 2016 by Imaging Development Systems GmbH
...
/* Pixel forcv::Mats */
#define IS_CM_FORcv::Mat_PACKED                 0x0000
...
/* Video forcv::Mat selectors   (Falcon) */
...
/* Decicv::Mation modes   (Falcon) */
#define IS_GET_DECIcv::MatION_MODE              0x8000
#define IS_GET_DECIcv::MatION_NUMBER            0x8001

#define IS_DECIcv::MatION_OFF                   0
#define IS_DECIcv::MatION_CONSECUTIVE           1
#define IS_DECIcv::MatION_DISTRIBUTED           2
...
IDSEXP   is_SetDecicv::MationMode           (HIDS hf, INT nMode, INT nDecicv::Mate);
...
IDSEXP   is_SaveImageEx                 (HIDS hf, const IS_CHAR* File, INT fileForcv::Mat, INT Param);
IDSEXP   is_SaveImageMemEx              (HIDS hf, const IS_CHAR* File, char* pcMem, INT nID, INT FileForcv::Mat, INT Param);
