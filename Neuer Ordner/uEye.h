...
#define IS_INVALID_COLOR_FORcv::Mat             174   // invalid color forcv::Mat
...
#define IS_INVALID_CAMERA_TYPE              180   // the camera type in the ini file doesn't cv::Match
...
#define IS_SUBNETMASK_MIScv::MatCH                      198   // The subnetmasks of the device and the adapter differ
#define IS_SUBNET_MIScv::MatCH                          199   // The subnets of the device and the adapter differ
...
/*! \brief Read current color forcv::Mat in function is_SetColorMode, \ref is_SetColorMode */
#define IS_GET_COLOR_MODE                   0x8000

/*! \brief Planar vs packed forcv::Mat */
#define IS_CM_FORcv::Mat_PLANAR                 0x2000
#define IS_CM_FORcv::Mat_MASK                   0x2000
...
/*! \brief This flag indicates whether a packed source pixelforcv::Mat should be used (also for the debayered pixel forcv::Mats) */
#define IS_CM_PREFER_PACKED_SOURCE_FORcv::Mat   0x4000

/*!
 * \brief Enumeration of pixel forcv::Mats supported by the function is_SetColorMode, \ref is_SetColorMode.
 */
...
#define IS_CM_RGB8_PLANAR           (1 | IS_CM_ORDER_RGB | IS_CM_FORcv::Mat_PLANAR)
...
#define IS_CCOR_SET_IR_AUTOcv::MatIC            0x0080
...
#define DR_SET_STEAL_FORcv::Mat                     23
#define DR_GET_STEAL_FORcv::Mat                     24
...
#define IS_TEST_IMAGE_ANIcv::MatED_WEDGE_GRAY           0x00000080

#define IS_TEST_IMAGE_ANIcv::MatED_WEDGE_COLOR          0x00000100
...
#define IS_TEST_IMAGE_ANIcv::MatED_LINE                 0x00008000
...
#define IS_TEST_IMAGE_ANIcv::MatED_WEDGE_GRAY_SENSOR    0x20000000
...
// ----------------------------------------------------------------------------
  ...
  typedef enum  eUEYE_GET_ESTIcv::MatED_TIME_MODE
  {
      IS_SE_STARTER_FW_UPLOAD =   0x00000001, /*!< get esticv::Mated duration of GigE SE starter firmware upload in milliseconds */
      IS_CP_STARTER_FW_UPLOAD =   0x00000002, /*!< get esticv::Mated duration of GigE CP starter firmware upload in milliseconds */
      IS_STARTER_FW_UPLOAD    =   0x00000004  /*!< get esticv::Mated duration of starter firmware upload in milliseconds using hCam to */
  } UEYE_GET_ESTIcv::MatED_TIME_MODE;
  ...
  typedef struct _UEYEIMAGEINFO
  {
    ...
    IDSEXP is_ImageForcv::Mat (HIDS hCam, UINT nCommand, void *pParam, UINT nSizeOfParam);


    typedef enum E_IMAGE_FORcv::Mat_CMD
    {
       IMGFRMT_CMD_GET_NUM_ENTRIES              = 1,  /* Get the number of supported image forcv::Mats.
       ...
       IMGFRMT_CMD_GET_LIST                     = 2,  /* Get a array of IMAGE_FORcv::Mat_ELEMENTs.                                  */
       IMGFRMT_CMD_SET_FORcv::Mat                   = 3,  /* Select a image forcv::Mat                                                  */
       IMGFRMT_CMD_GET_ARBITRARY_AOI_SUPPORTED  = 4,  /* Does the device supports the setting of an arbitrary AOI.              */
       IMGFRMT_CMD_GET_FORcv::Mat_INFO              = 5   /* Get IMAGE_FORcv::Mat_INFO for a given forcv::MatID                             */
    ...
    typedef struct S_IMAGE_FORcv::Mat_INFO
    {
        INT  nForcv::MatID;                     /* Image forcv::Mat ID.                                                         */
        UINT nWidth;                        /* Width.                                                                   */
        UINT nHeight;                       /* Height.                                                                  */
        ...
        IS_CHAR strForcv::MatName[64];          /* Forcv::Mat name.                                                             */
        double dSensorScalerFactor;         /* Sensor scaler factor.                                                    */
        UINT nReserved[22];
    } IMAGE_FORcv::Mat_INFO;


    typedef struct S_IMAGE_FORcv::Mat_LIST
    {
        ...
        IMAGE_FORcv::Mat_INFO Forcv::MatInfo[1];    /* First forcv::Mat entry.             */
    } IMAGE_FORcv::Mat_LIST;
...
IDSEXP is_FaceDetection (HIDS hCam, UINT nCommand, void *pParam, UINT nSizeOfParam);
    ...
    */
    ...
    {
      SCENE_INVALID             = 0,
      SCENE_SENSOR_AUTOcv::MatIC    = 0x00000001,
...
typedef enum E_TRIGGER_DEBOUNCE_MODE
{
    ...
    TRIGGER_DEBOUNCE_MODE_AUTOcv::MatIC         = 0x0008
 ...
 * The callback function is required to fill provide this inforcv::Mation to the API.
 *
 * This type is used for the following callback events:
...
/*!
 * \brief Function for different conversions (e.g. raw images to different pixelforcv::Mats)
 * \param   hCam            valid device handle.
 * \param   nCommand        specifies the command
 * \param   pParam          input or output storage for the accessed param.
 * \param   cbSizeOfParam   size of *pParam.
